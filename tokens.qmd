...
After describing the various categories and classes of Digital Assets we'll then delve into the Markets existing for these Digital Assets, as well as how an entity [hodls](./terms.qmd#hodl) the Digital Asset and the yield properties of the various types of Digital Assets. 
...
### Base Networks
This Almanack distinguishes between the financial properties of Coins versus the technical properties of a [Blockchain](./blockchains.qmd). As such we don't refer to networks here by Layer 1 or Layer 2. That's a classification and distinction you can explore [here](./terms.qmd#layer-1). 
...
#### ICS20
The Inter-Chain Standard 20 is a [Cosmos](./trollip_index.qmd#cosmos-hub) based standard for fungible token transfers between blockchains using the Inter-Blockchain Communication Protocol (IBC)
