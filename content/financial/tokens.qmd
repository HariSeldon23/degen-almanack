...
After describing the various categories and classes of Digital Assets we'll then delve into the Markets existing for these Digital Assets, as well as how an entity [hodls](../essentials/terms.qmd#hodl) the Digital Asset and the yield properties of the various types of Digital Assets. 
...
### Base Networks
This Almanack distinguishes between the financial properties of Coins versus the technical properties of a [Blockchain](../technical/blockchains.qmd). As such we don't refer to networks here by Layer 1 or Layer 2. That's a classification and distinction you can explore [here](../essentials/terms.qmd#layer-1). 
...
Please see [Ozempic Effect](../financial/ratings.qmd/#ozempic-effect) to see how we determine if a network in a net ozempic or sugar network. 
