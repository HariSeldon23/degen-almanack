...
## Trading
### Wash trading
Wash trading is the practice of manipulating the trading volume of an exchange. It's when trading occurs between related parties used to inflate the real volume occuring. An example, would be a CEX holds two accounts and constantly trade between themselves. 
