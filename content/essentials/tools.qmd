...
## CEX's
Centralized Exchanges are a necessary evil in Web3. They can be used for trading and purchasing Digital Assets and generally offer better rates and lower fee's than their decentralized counterparts. However they're generally not to be trusted as seen by some notable CEX failures in the not too distant past:
...
Notice how in 2022, contagion became pretty prevalent. This is why the [not your keys, not your coins](../essentials/memes.qmd#not-your-keys-not-your-coins) meme is so popular. 

You can view and evaluate CEX's on [CoinGecko](https://www.coingecko.com/en/exchanges). Take careful note of the Trust Score. A lot of CEX's engage in [wash trading](../essentials/terms.qmd#wash-trading) and that's why it's important to have someone independently verify their stated trading volumes.
...
| [Pulsar Finance](https://app.pulsar.finance/portfolio) | Account (EVM), UTXO, Capability Model, Cosmos | Support for the most chains. But values can be wrong | Ethereum, Base, Cosmos, Solana, Bitcoin, Sui, Aptos, Near, Cardano | Widest coverage in the market |
