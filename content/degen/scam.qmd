...
## Private Key Management
A large part of the early vision of crypto was to create a currency with the absence of a central authority (read Government). Indeed the first Bitcoin block, mined by [Satoshi](../essentials/icons.qmd#satoshi-nakamoto) contained a message admonishing the central banks. 
...
### Gas Fee misunderstandings
To be truly proficient with Gas you should understand deeply [Fee Markets](../technical/blockchains.qmd#fee-markets)
